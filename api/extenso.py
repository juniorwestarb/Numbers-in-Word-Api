...
decenas = ["dez", "onze", "doze", "treze", "quatorze", "quinze", "dezesseis", "dezessete", "dezoito", "dezenove"]
...
def centenas(num):
    ...
    if a == 0:
        if b == 0:
            ...
            if c == 0:
                resultado = dezenas[b-1]
                return resultado
            if c >= 1 and c <= 9:
                resultado = dezenas[b-1]+' e '+unidades[c]
                return resultado
    if a == 1:
        if b == 0:
            if c == 0:
            ...
            if c == 0:
                resultado = 'cento e '+dezenas[b-1]
                return resultado
            elif c > 0 and c <= 9:
                resultado = 'cento e '+dezenas[b-1]+ ' e '+unidades[c]
                return resultado
        ...
        if b == 0:
            ...
            if c == 0:
                resultado = prefix+dezenas[b-1]
                return resultado
            elif c > 0 and c <= 9:
                resultado = prefix+dezenas[b-1]+' e '+unidades[c]
                return resultado

def validaNegativoeZero(num):
    if int(num) == 0:
        return unidades[0]
    if num[0] == "-":
        return "menos "
